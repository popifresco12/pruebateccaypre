    ...
    <v-flex xs12 sm8 md6>
      <v-card>
        ...
        <v-card-text>
          ...
          <ul>
            <li>Descargar y clonar el repositorio desde la siguiente dirección de Git</li>
            <li>Al final del documento encontrareis una tabla con una serie de datos. <b>Sin modificar el código proporcionado en el repositorio y a continuación de la tabla,</b> se deben mostar los datos como si se trataran de fichas de producto. El resultado debe ser parecido al de la <a href="https://prueba.caypre.es/img/captura1.jpg" target="new">siguiente imagen</a>, podéis ser tan creativos como querais.</li>
          </ul>
          <br>
          ...
          <ul>
            ...
            <li><b>Extra:</b> Obtener los datos a mostrar desde una base de datos.</li>
            <li><b>Extra:</b> Subir el resultado a una nueva rama en el repositorio público de Git con vuestro usuario de Git, sin destruir el repositorio actual.</li>
